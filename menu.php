...
<body>
    <nav class="navbar navbar-expand-sm navbar navbar-dark navbar sticky-top" style="background-color: black;">
        ...
        <img src="img/logoNav.jpg" alt="" width="150" class="d-inline-block align-text-top"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="tienda.php" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">TIENDA</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="pagH.php">HOMBRE</a>
                        <a class="dropdown-item" href="pagM.php">MUJER</a>
                        <a class="dropdown-item" href="pagA.php">ACCESORIOS</a>
                    </div>
                </li>
                <li class="nav-item">
            ...
            <ul class="nav navbar-nav flex-row justify-content-between ml-auto">
                <li class="nav-item order-2 order-md-1"><?php include("carrito.php"); ?></li>
