...
function obtenerProductosEnCarrito()
{
    ...
    $sentencia = $bd->prepare("SELECT productos.idprod, productos.nombre, productos.descripcion, productos.precio, productos.imagen
     FROM productos
     INNER JOIN carrito_usuarios
     ON productos.idprod = carrito_usuarios.id_producto
...
{
    $bd = obtenerConexion();
    $sentencia = $bd->query("SELECT idprod, nombre, descripcion, precio, existencia, imagen FROM productos");
    return $sentencia->fetchAll();
}
